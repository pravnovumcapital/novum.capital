                    ...
                    <div class="container-fluid">
						...
						<!---
							<div class="alert alert-danger fade show m-b-0">
								<h4>IMPORTANT!</h4>
								<p>
									Please upload your Identification documents in order for us to verify your identity. Consentium and Novum Capital will never share your details or documents with anyone. Your information will be kept with the strictest confidence.
								</p>
								<p>
