		...
		<div class="wrapper-page">
			<div class="card-box">
				<div class="panel-heading">
					<h3 class="text-center"> Sign Up for <strong class="text-custom">Consentium TGE</strong> </h3>
				</div>
...
--->
						...
						<div class="form-group">
							<div class="col-12">
								<div class="checkbox checkbox-primary">
									...
									<label for="checkbox-signup">I accept <a href="terms.html" target="_blank">Consentium's Terms and Conditions</a></label>
								</div>
							</div>
						</div>
						...
						<div class="form-group text-center m-t-40">
							<div class="col-12">
								...
								<input type="hidden" name="tgetitle" value="Consentium Token Sale">
			...
			<div class="row">
				<div class="col-12 text-center">
					<p>
						Already have an account?<a href="index.cfm" class="text-primary m-l-5"><b>Sign In</b></a>
					</p>
				</div>
			</div>
