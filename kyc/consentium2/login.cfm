...
<html>
    <head>
        ...
        <meta name="description" content="Welcome to Consentium Token Generation Event">
        ...
        <div class="wrapper-page">
            <div class="card-box">
                <div class="panel-heading">
                    <h4 class="text-center"> Log In to <strong class="text-custom">Consentium Token Generation Event</strong></h4>
                </div>
                ...
                <div class="p-20">
                    <form class="form-horizontal m-t-20" method="post" action="investormain.cfm">
                        ...
                        <div class="form-group ">
                            <div class="col-12">
                            <cfif Isdefined("URL.e91kdaskk09f8fhj1k2312")>
                                <cfoutput><input class="form-control" name="email" type="text" value="#URL.e91kdaskk09f8fhj1k2312#" required="" placeholder="Email"></cfoutput>
                            <cfelse>
                        ...
                        <input type="hidden" name="tgesource" value="3">
                    </form>
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p>First time contributing to Consentium TGE? <a href="index.cfm" class="text-primary m-l-5"><b>Sign Up</b></a>
                    </p>
