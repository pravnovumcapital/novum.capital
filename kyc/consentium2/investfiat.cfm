                    ...
                    <div class="container-fluid">
						...
						<Cfelseif session.kycstatus eq 2>
							...
							<div class="alert alert-success fade show m-b-0">
								...
								<p>
									We are still processing your application. Once it is approved, you will be able to view the Bank transfer information.
								</p>
									
							</div>
						<Cfelseif session.kycstatus eq 3>
								<h4>Congratulations! You have passed the KYC!</h4><br><Br>
								...
								<tr>
								<td>Name of Bank:</td>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>Oversea-Chinese Banking Corporation Limited Singapore</b></td>
								</tr>
								<tr>
								<td>Name of Account:</td>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>Asia Focus Group Pte Ltd</b></td>
								</tr>
								<tr>
								<td>Company Address:</td>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>160 Robinson Road, #12-03, SBF Center, Singapore 068914</b></td>
								</tr>
								<tr>
								<td>Account Number:</td>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;<b></b> <img src="AFGBankAcc.png"></td>
								</tr>
								<tr>
								<td>SWIFT:</td>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>OCBCSGSG</b></td>
								...
								<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>65 Chulia Street OCBC, Singapore 049513 </b></td>
								</tr>
								<tr>
								<td>Country of Bank:</td>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>Singapore</b></td>
								</tr>
								
								</table>
								</p>
								<p>Please include this instruction in your telegraphic transfer if your bank allows: "<font color='##FFFFFF'><cfoutput>CONSENTIUM-#session.indexkey#</font></cfoutput>"
								<p>
								After you have made the transfer, please email to hello@consentium.net with the following information:
								<ul>
								<li>Date of transfer</li>
								<li>Amount</li>
								<li>Currency</li>
								<li>Your phone number</li>
								<li>Sender ID: <cfoutput>CONSENTIUM-#session.indexkey#</cfoutput></li>
								<li>Confirmation ID or screen shot of transfer, if any</li>
								</ul>
								We will keep a look out for your investment and email you to confirm receipt of your contribution.
								</p>
