                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Consentium Token Generation Event Agreement</h4>
						...
						<div class="alert alert-info">
							You have agreed to all the terms stated in the Consentium Token Generation Event Agreement during the Sign Up process.
							A copy of the Agreement is published below. If you do not agree to any of the terms, you must NOT participate in Consentium Token Generation Event.
						</div>

						<div class="alert alert-success fade show m-b-0">
							<h4><a href="https://consentium.net/kyc/terms.html"  target="_blank"><center>Consentium Terms and Conditions (click)</center></a></h4>
							<p>
