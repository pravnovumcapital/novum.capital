		...
		<div class="wrapper-page">
			<div class="card-box">
				<div class="panel-heading">
					<h3 class="text-center"> Sign Up for <strong class="text-custom">Consentium Token Sale Event</strong> </h3>
				</div>
						...
						<div class="form-group">
							<div class="col-12">
								<div class="checkbox checkbox-primary">
									...
									<label for="checkbox-signup">I accept <a href="https://consentium.net/kyc/terms.html" target="_blank">Consentium's Terms and Conditions</a></label>
								</div>
							</div>
						</div>
