    ...
    <head>
       ...
       <link href="../plugins/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
        ...
        function validatekyc()
        {
        	...
        	{
        		alert("Please agree to the Consentium Terms and Conditions. If you do not agree, you must NOT participate in this Token Generation Event.");
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Join the Consentium Token Sale</h4>
									   ...
									   <form id="basic-form" action="processkyc.cfm" method="post" onsubmit="return validatekyc()" enctype="multipart/form-data">
												<div>
															...
															<div class="col-lg-12">
															 ...
															 <div class="checkbox checkbox-success checkbox-circle">
																...
																<label for="checkbox-10">
																	I have read and understood the Terms and Conditions stated in the <a href="agreement.cfm">Consentium Token Sale And Subscription Agreeement</a> and the Consentium Whitepaper and that I expressly accept all terms, conditions, obligations, affirmations, representations and warranties described in these documents and agree to be bound by them.
																</label>
															 </div>
													...
													<section>
														...
														<div class="form-group clearfix">
															<label class="control-label" for="name2">Please upload your passport page showing your photo * (only JPG, GIF, PNG or PDF)</label>
															<input type="file" class="filestyle" name="passportfile" data-input="false">
														</div>
														<div class="form-group clearfix">
															<label class="control-label " for="surname2">Please upload your front and bank Citizen ID card * (only JPG, GIF, PNG or PDF)</label>
...
5. You are of a legal age in your local jurisdiction to enter into a contract or agreement.														
														...
														<p><font color="##FF0000">IMPORTANT: Do not click the FINISH button twice. It will take several minutes for your documents to be uploaded. Please be patient.</font></p>
