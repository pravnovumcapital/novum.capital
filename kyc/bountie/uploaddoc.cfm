    ...
    <head>
       ...
       <link href="../plugins/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
        ...
        function validatekyc()
        {
        	...
        	{
        		alert("Please agree to the Bountie Terms and Conditions. If you do not agree, you must NOT participate in this Token Generation Event.");
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Getting to Know You</h4>
									...
									<div class="col-md-12">
										<div class="card-box">
											...
											<p class="text-muted m-b-30 font-13">
												Bountie has engaged Novum Capital to help perform Know Your Customer (KYC) check. KYC checks are mandatory for compliance with Anti-Money Laundering Acts and other regulations required by local authorities.
															...
															<div class="col-lg-12">
															 ...
															 <div class="checkbox checkbox-success checkbox-circle">
																...
																<label for="checkbox-10">
																	I have read and understand the Terms and Conditions stated in the <a href="agreement.cfm" target="_blank">Bountie Token Sale And Subscription Agreeement</a> and the Bountie Whitepaper and that I expressly accept all terms, conditions, obligations, affirmations, representations and warranties described in these documents and agree to be bound by them.
																</label>
															 </div>
