        ...
        <div class="wrapper-page">
            <div class="card-box">
                <div class="panel-heading">
                    <h4 class="text-center"> Sign In to <strong class="text-custom">Bountie Token Generation Event</strong></h4>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p>First time contributing to Bountie TGE? <a href="register.cfm" class="text-primary m-l-5"><b>Sign Up</b></a>
                    </p>
