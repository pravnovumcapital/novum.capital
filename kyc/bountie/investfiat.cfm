                ...
                <div class="content">
                    <div class="container-fluid">
						...
						<Cfelseif session.kycstatus eq 3>
								...
								<tr>
								<td>Name of Bank:</td>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>Development Bank of Singapore</b></td>
								</tr>
								<tr>
								<td>Name of Account:</td>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>Bountie Pte Ltd</b></td>
								</tr>
								<tr>
								<td>Account Number:</td>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>70018293123</b></td>
								</tr>
								<tr>
								<td>SWIFT:</td>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>DBSSSGSG</b></td>
								...
								<p>Please include this instruction in your telegraphic transfer if your bank allows: "<font color='##FFFFFF'><cfoutput>BOUNTIE-#session.indexkey#</font></cfoutput>"
								<p>
								After you have made the transfer, please email to bountie@novum.capital with the following information:
								<ul>
								...
								We will keep a look out and email you to confirm receipt of your contribution.
								</p>
