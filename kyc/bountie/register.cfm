...
<html>
	<head>
		...
		<meta name="description" content="Welcome to Bountie Token Generation Event">
		...
		<div class="wrapper-page">
			<div class="card-box">
				<div class="panel-heading">
					<h3 class="text-center"> Sign Up for <strong class="text-custom">Bountie TGE</strong> </h3>
				</div>
...
--->
						...
						<div class="form-group">
							<div class="col-12">
								<div class="checkbox checkbox-primary">
									...
									<label for="checkbox-signup">I accept <a href="terms.html" target="_blank">Bountie's Terms and Conditions</a></label>
								</div>
							</div>
						</div>
						...
						<div class="form-group text-center m-t-40">
							<div class="col-12">
								...
								<input type="hidden" name="tgetitle" value="Bountie ICO">
