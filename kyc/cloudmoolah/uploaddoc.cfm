<CFIF IsDefined("Form.email") AND IsDefined("Form.password")>
	...
	<cfif InvestorExist.RecordCount eq 1>
		...
		<Cfelse>
			...
			<CFLOCATION URL="http://kyc.novum.capital/CloudMoolah/index.cfm?e=2">

		</cfif>
	<Cfelse>
			<!--- redirect back to login page --->
			<CFLOCATION URL="http://kyc.novum.capital/CloudMoolah/index.cfm?e=3">
...
<html>
    <head>
       ...
       <link href="../plugins/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
        ...
        {
            if(document.getElementById('checkbox-10').checked == false)
        	{
        		alert("Please agree to the CloudMoolah Terms and Conditions. If you do not agree, you must NOT participate in this Token Generation Event.");
        		document.getElementById('acceptTerms-3').focus();
        		return false;
        	}
        	
         	if(document.getElementById('checkbox-11').checked == false)
        	{
        		alert("Please agree to the statement regarding your legal right to participate in a Token Generation Event or ICO. If you do not agree, you must NOT participate in this Token Generation Event.");
        		document.getElementById('acceptTerms-4').focus();
        		return false;
        		
        	}     	
        	if(document.getElementById('firstname').value.length == 0)
        	{
        		alert("Please enter your First Name in the [Profile] tab");
        		document.getElementById('firstname').focus();
        		return false;
        	}
        	if(document.getElementById('lastname').value.length == 0)
        	{
        		alert("Please enter your Last Name or Surname in the [Profile] tab.");
        		document.getElementById('lastname').focus();
        		return false;
        	}
        	if(document.getElementById('citizenid').value.length == 0)
        	{
        		alert("Please enter your Citizen Identification Number in the [Profile] tab.");
        		document.getElementById('citizenid').focus();
        		return false;
        	}
        	if(document.getElementById('dob').value.length == 0)
        	{
        		alert("Please enter your Date of Birth in MM/DD/YYYY format in the [Profile] tab.");
        		document.getElementById('citizenid').focus();
        		return false;
        	}
        	if(document.getElementById('checkbox-12').checked == false)
        	{
        		alert("Please agree to Novum Capital's Terms and Conditions in the [Disclaimer] tab. If you do not agree, you must NOT participate in this Token Generation Event.");
        		document.getElementById('acceptTerms-2').focus();
        		return false;
        	}
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="agreement.cfm" class="waves-effect"><i class="ti-file"></i> <span> CloudMoolah Agreement </span> </a>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Join the CloudMoolah Token Sale</h4>
									...
									<div class="col-md-12">
										<div class="card-box">
											...
											<p class="text-muted m-b-30 font-13">
												CloudMoolah has engaged Novum Capital to help perform Know Your Customer (KYC) check. KYC checks are mandatory for compliance with Anti-Money Laundering Acts and other regulations required by local authorities.
															...
															<div class="col-lg-12">
															 ...
															 <div class="checkbox checkbox-success checkbox-circle">
																...
																<label for="checkbox-10">
																	I have read and understand the Terms and Conditions stated in the <a href="agreement.cfm" target="_blank">CloudMoolah Token Sale And Subscription Agreeement</a> and the CloudMoolah Whitepaper and that I expressly accept all terms, conditions, obligations, affirmations, representations and warranties described in these documents and agree to be bound by them.
																</label>
															 </div>
