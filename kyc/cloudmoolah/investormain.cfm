		...
		<cfelse>
			...
			<cfif InvestorExist.RecordCount eq 1>
				...
				<Cfelse>
					...
					<CFLOCATION URL="login.cfm?e=2">

				</cfif>			
				
			<cfelse>
				<CFLOCATION URL="login.cfm?e=3">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Welcome to CloudMoolah ICO</h4>
						...
						<!---
							<div class="alert alert-danger fade show m-b-0">
								<h4>IMPORTANT!</h4>
								<p>
									Please upload your Identification documents in order for us to verify your identity. CloudMoolah and Novum Capital will never share your details or documents with anyone. Your information will be kept with the strictest confidence.
								</p>
								<p>
