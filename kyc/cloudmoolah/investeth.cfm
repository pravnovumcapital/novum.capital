<CFIF IsDefined("Form.email") AND IsDefined("Form.password")>
	...
	<cfif InvestorExist.RecordCount eq 1>
		...
		<Cfelse>
			...
			<CFLOCATION URL="https://kyc.novum.capital/CloudMoolah/index.cfm?e=2">

		</cfif>
	<Cfelse>
			<!--- redirect back to login page --->
			<CFLOCATION URL="https://kyc.novum.capital/CloudMoolah/index.cfm?e=3">
                ...
                <div class="content">
                    <div class="container-fluid">
						...
						<Cfelseif session.kycstatus eq 3 and len(session.ethwallet) gt 3>
								<p>
									Congratulations! You have passed the KYC!
								</p>
								<p>
